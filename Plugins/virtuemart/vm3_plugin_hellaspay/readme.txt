INSTALLATION:
1) Install the [vm3_plugin_hellaspay.zip] plugin through Joomla extension manager (Install).
2) Activate the [VM - Payment, VivaPayments] plugin through Joomla extension manager (Manage). 
3) Add the new payment method (Virtuemart/Shop/Payment Methods) and set parameters / configuration.
4) Set a new source in the VivaPayments backoffice with following success / fail links:
