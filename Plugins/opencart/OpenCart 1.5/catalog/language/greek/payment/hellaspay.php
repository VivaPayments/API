...
$_['text_title']		= 'Με πιστωτική κάρτα (Viva Payments)'; # checkout payment option
$_['text_checkout']		= 'Ταμείο';

$_['text_to_hellaspay']		= '<strong>Προσοχή: </strong>Πατώντας επιβεβαίωση θα μεταφερθείτε σε ασφαλές τραπεζικό σύστημα για την ολοκλήρωση της πληρωμή σας.';
