...
<div id="content">
	...
	<div class="box">
		<div class="heading">
			<h1><img src="view/image/payment.png" alt="Vivawallet" /><?php echo $heading_title; ?></h1>
		...
		<tr>
          ...
          <td>
          <textarea name="vivawallet_orderurl" cols="40" rows="5"><?php echo $vivawallet_orderurl; ?></textarea>
          </td>
        </tr> 
		...
		<tr>
          ...
          <td>
          <textarea name="vivawallet_url" cols="40" rows="5"><?php echo $vivawallet_url; ?></textarea>
          </td>
        </tr> 
        <tr>
            <td><?php echo $entry_total; ?></td>
            <td><input type="text" name="vivawallet_total" value="<?php echo $vivawallet_total; ?>" /></td>
          </tr>
