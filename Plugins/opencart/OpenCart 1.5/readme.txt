...
Success path: index.php?route=payment/vivawallet/callback&success
Fail path: index.php?route=payment/vivawallet/callback&fail

--------------------------------------------------------------------------------------------------
URL NOTE (FOR JOOMLA! MIJOSHOP USERS ONLY):

USING SEF URLs:
Success path: component/mijoshop/payment/vivawallet/callback?success
Fail path: component/mijoshop/payment/vivawallet/callback?fail

NOT USING SEF URLs:
Success path: index.php?option=com_mijoshop&route=payment/vivawallet/callback&success
Fail path: index.php?option=com_mijoshop&route=payment/vivawallet/callback&fail
