INSTALLATION:
-If applies, uninstall previous installed HellasPay / Viva Payments payment module (admin/modules)
-Install the new module (Modules - Install new module - Upload a module - select commerce_hellaspay-7.x-1.0.zip)
