INSTALLATION:
-If applies, uninstall previous installed HellasPay / Viva Payments module (admin/modules)
-Upload (ftp/ssh) the uc_deltapay directory with its content to:
(drupal installation)\modules\ubercart\payment\
-Enable the Viva Payments payment module (Administer/Modules)
-Configure the Viva Payments module (Administer › Store administration › Configuration › Payment settings)
-Set a new source in the Viva Payments backoffice with following success / fail links:

Success page: 
cart/hellaspay/complete?success

Failure page: 
cart/hellaspay/error?fail
-----------------------------------------------------------------------------------------------------------
Vivawallet setup:
