<?php
class Mage_Hellaspay_Block_Form_Cc extends Mage_Payment_Block_Form
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('hellaspay/form/cc.phtml');
    }
    ...
    public function displayInstallments()
    {
		...
		$instal_hellaspay[] = array($instal_term =>  $instal_term . $this->__(' installments'));
		}
		}
