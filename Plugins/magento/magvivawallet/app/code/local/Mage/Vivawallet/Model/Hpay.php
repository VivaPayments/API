...
class Mage_Vivawallet_Model_Hpay extends Mage_Payment_Model_Method_Abstract
{
	...
	protected $_formBlockType = 'vivawallet/form_cc';
    ...
    {
        return Mage::getSingleton('vivawallet/hpay_session');
    }
	...
	public function addVivawalletFields($form){
    ...
    public function createFormBlock($name)
    {
		...
		$block = $this->getLayout()->createBlock('vivawallet/hpay_form', $name)
            ->setMethod('hpay')
            ->setPayment($this->getPayment())
            ->setTemplate('vivawallet/hpay/form.phtml');
    ...
    {
		  return Mage::getUrl('vivawallet/hpay/redirect', array('_secure' => true)); //ssl
    }
