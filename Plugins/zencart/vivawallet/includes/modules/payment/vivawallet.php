...
// class methods
	...
	$db->Execute("insert into vivawallet_data (OrderCode, ErrorCode, ErrorText, Timestamp, ref, total_cost, currency, order_state, sessionid) values ('".$OrderCode."','".$ErrorCode."','".$ErrorText."',now(),'".$tm_ref_id."','".$vivawallet_amount."','".MODULE_PAYMENT_VIVAWALLET_CURRENCY."','I','". zen_session_id() . "')");
	...
	function install() {
      ...
      if (defined('MODULE_PAYMENT_VIVAWALLET_STATUS')) {
		...
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Currency', 'MODULE_PAYMENT_VIVAWALLET_CURRENCY', '978', 'The currency used for this shop (default 978 for Euro)', '6', '0', now())");
