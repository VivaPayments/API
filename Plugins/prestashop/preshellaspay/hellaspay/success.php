...
$errors = '';
  ...
  $update_query = "update hellaspay_data set order_state='P' where OrderCode='".$OrderCode."'";
  ...
  $details = array(
   ...
   $hellaspay->validateOrder((int)$cartid, _PS_OS_PAYMENT_, $total, $hellaspay->displayName, 'OrderCode: '.$OrderCode,$details,(int)$currency_payment,false,$secure_key);
   $currency = new Currency(intval(isset($_POST['currency_payement']) ? $_POST['currency_payement'] : $cookie->id_currency));
   $order = new Order($hellaspay->currentOrder);
   
   $delete_query = "delete from hellaspay_data where ref='".$cartid."'";
