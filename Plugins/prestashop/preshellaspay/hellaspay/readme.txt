...
-Enable and configure Vivapayments module.
-At your Vivapayments backoffice create a new payment source:

Success page: modules/hellaspay/success.php
Fail page: modules/hellaspay/fail.php
