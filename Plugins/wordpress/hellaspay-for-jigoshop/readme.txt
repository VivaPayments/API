INSTALLATION:
-Install new pluging through wp-admin (Upload - select hellaspay-for-jigoshop.zip) 
-Activate the Jigoshop Viva Payments Payment Gateway
-In Jigoshop - settings - Payment Gateways: select Viva Payments and configure the module
-Create a new source in your Viva Payments backoffice and use the following URLs:

SUCCESS URL: ?js-api=JS_Gateway_Hellaspay&success
FAIL URL: ?js-api=JS_Gateway_Hellaspay&fail
