INSTALLATION:
-Upload the hellaspay.php to:
(wpinstallation)/wp-content/plugins/wp-e-commerce/wpsc-merchants/
-Configure the Viva Payments option through the store admin.
-Create a new source in the Viva Payments backoffice, use following URLs:

Success URL:
index.php?hellaspay_callback=true&success=true 

Fail URL:
index.php?hellaspay_callback=true&fail=true
