...
{assign var="success_url" value="`$config.http_location`/`$config.customer_index`?dispatch=payment_notification.success&payment=hellaspay"}
{assign var="failure_url" value="`$config.http_location`/`$config.customer_index`?dispatch=payment_notification.fail&payment=hellaspay"}
<p>{$lang.text_hellaspay_notice|replace:"[success_url]":$success_url|replace:"[failure_url]":$failure_url}</p>
<hr />
