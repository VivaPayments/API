...
('Viva Payments', 'vivawallet.php', 'views/orders/components/payments/vivawallet.tpl', 'vivawallet.tpl', 'N', 'P');

INSERT INTO `cscart_language_values` (`lang_code` ,`name` ,`value`) VALUES 
('en', 'vivawallet_instalments', 'Instalments'), 
('el', 'vivawallet_instalments', 'Δόσεις');

INSERT INTO `cscart_language_values` (`lang_code` ,`name` ,`value`) VALUES 
('en', 'vivawallet_no_instalments', 'No Instalments'), 
('el', 'vivawallet_no_instalments', 'Χωρίς Δόσεις');

INSERT INTO `cscart_language_values` (`lang_code` ,`name` ,`value`) VALUES 
('en', 'vivawallet_instalments_step', 'Instalment steps'), 
('el', 'vivawallet_instalments_step', 'Instalment steps');

INSERT INTO `cscart_language_values` (`lang_code` ,`name` ,`value`) VALUES 
('en', 'vivawallet_instalments_start', 'First instalment'), 
('el', 'vivawallet_instalments_start', 'First instalment');
...
-------------------------------------------------------------------------------
4. Copy the files to your store root (no files are overwritten).
-------------------------------------------------------------------------------
5. Add a the new payment method through your store admin, 
a. select from dropdown template -vivawallet.tpl-
