{assign var="success_url" value="payment_notification.success?payment=hellaspay"|fn_url:'C':'http'}
{assign var="failure_url" value="payment_notification.fail?payment=hellaspay"|fn_url:'C':'http'}
<p>{__("text_hellaspay_notice", ["[success_url]" => $success_url, "[failure_url]" => $failure_url])}</p>
<hr>
