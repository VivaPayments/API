...
$request =  'http://demo.vivapayments.com/api/transactions/'.$TID;	// demo environment URL
//$request =  'https://www.vivapayments.com/api/transactions/'.$TID;	// production environment URL
